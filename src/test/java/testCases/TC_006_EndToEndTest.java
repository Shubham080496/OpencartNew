...
public class TC_006_EndToEndTest extends BaseClass {
	...
	hp.enterProductName(rb.getString("searchProductName"));
	hp.clickSearch();
	
	SearchPage sp=new SearchPage(driver);
	
	if(sp.isProductExist(rb.getString("searchProductName")))
	{
		sp.selectProduct(rb.getString("searchProductName"));
		sp.setQuantity("2");
		sp.addToCart();
	...
	myassert.assertEquals(totprice, "$602.00");   //validation
